...
def random_question():
    all_question = [u"您母亲的姓名是？----大乔",u"您配偶的生日是？----19960518",
                    u"您的学号(或工号)是？----99",u"您高中班主任的名字是？----狄仁杰",
                    u"您父亲的姓名是？----姜子牙",u"您小学班主任的名字是？----后羿",
                    u"您父亲的生日是？----19951212",u"您配偶的姓名是？----孙尚香",
                    u"您初中班主任的名字是？----赵云",u"您最熟悉的童年好友名字是？----亚瑟",
                    u"您最熟悉的学校宿舍室友名字是？----张飞"]
